...
"}")
        ...
        self.ai_chat_widget.setMaximumSize(QSize(240, 16777215))
        ...
        self.word_card_widget.setMaximumSize(QSize(240, 16777215))
        ...
        self.sentence_card_widget.setMaximumSize(QSize(240, 16777215))
